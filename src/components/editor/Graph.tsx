...
export const Graph: React.FC<PropsWithClassName<GraphProps>> = ({
    ...
    return (
        <div className={classNames('relative', className)}>
            ...
            <div className="absolute top-0 left-0 w-[10px] h-[10px] border-t-2 border-l-2 border-stone-200 rotate-45 translate-x-[-6px]" />
            <div className="absolute bottom-0 right-0 w-[10px] h-[10px] border-b-2 border-r-2 border-stone-200 -rotate-45 translate-y-[6px]" />
            <canvas
                width={width}
                height={height}
                ref={(canvas) => {
